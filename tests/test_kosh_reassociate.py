...
class KoshTestReassociate(KoshTest):
    def test_dataset_reassociate(self):
        ...
        self.assertEqual(len(list(ds.search(uri=filename))), 1)
    ...
    def test_command_line_multi_files(self):
        ...
        run_reassociate([db_uri, ], [filename1, filename2],
                        [old_name1, old_name2])
        self.assertEqual(len(list(ds.search(uri=filename1))), 1)
        self.assertEqual(len(list(ds.search(uri=filename2))), 1)
